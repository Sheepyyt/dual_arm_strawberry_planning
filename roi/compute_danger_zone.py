...
# Grid bounding box (vehicle frame, XY plane) — generous margins
GRID_X_MIN, GRID_X_MAX = -0.80, 0.80
GRID_Y_MIN, GRID_Y_MAX = -0.90, 0.90

# Capsule radius (m) for approximating each link as a thick line segment.
# A reasonable value for small agricultural manipulator links.
LINK_RADIUS = 0.03

# Number of random joint configurations to sample per arm
N_SAMPLES = 200_000

# ROI upper / lower half regions
ROI_UPPER = {"x_min": -0.50, "x_max": 0.50, "y_min": 0.25, "y_max": 0.65}
ROI_LOWER = {"x_min": -0.50, "x_max": 0.50, "y_min": -0.65, "y_max": -0.25}
